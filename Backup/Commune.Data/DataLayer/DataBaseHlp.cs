...
namespace Commune.Data
{
  public class DataBaseHlp
  {
    ...
    public static int RowsCount(IDataLayer dbConnection, string database, string tableName, string condition,
      params DbParameter[] parameters)
    {
      object rawCount = dbConnection.GetScalar(database, string.Format("Select count(*) From {0} {1}",
        tableName, condition), parameters);
